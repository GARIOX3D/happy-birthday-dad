...
function initCanvasScene(){
    ...
    canvasCamera.position.set(0,0, 1400);//test
	...
	rocketMaterial = new THREE.MeshLambertMaterial({color: 0xffffff, wireframe:false });
	...
	loadModel("js/models/rocket.js", 0, 0, 0, 1.0, 0, 0, 0, rocketMaterial)
...
function canvasAnimate(){
	...
	// console.log(h);
	rocketMaterial.color.setHSL((Math.cos(Date.now()*0.0005)*0.5 + 0.5), 1.0, 0.5 );
